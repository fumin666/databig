        ...
        series : [
            {
                name:'sales',
                type:'bar',
                data:[2,4,5,28,29,78,138,162,32,25,8,5],
                markPoint : {
                    data : [
                        {type : 'max', name: '最大值'},
                        {type : 'min', name: '最小值'}
            ...
            },
            {
                name:'purchases',
                type:'bar',
                data:[3,6,10,28,29,71,178,180,48,24,8,3],
                markPoint : {
                    data : [
        ...
        series : [
            {
                ...
                selectedMode: 'single',
                data:[
                    {value:70, name: 'Direct Access'},
                    {value:78, name: 'E-mail Marketing'},
                    {value:59, name: 'Union Ad'},
                    {value:30, name: 'Video Ads'},
                    {value:360, name: 'Search Engine'}
                ]
            }
        ]
    };
        ...
        series: [
            {
                ...
                selectedMode: 'single',
                data:[
                    {value:310,name: 'Direct Access'},
                    {value:150, name: 'E-mail Marketing'},
                    {value:368, name: 'Union Ad'},
                    {value:380, name: 'Video Ads'},
        ...
        radar: [
            {
                indicator: [
                    {text: 'Sales', max: 5500},
                    {text: 'stration', max: 15000},
                    {text: 'hology', max: 30000},
                    {text: 'Customer Support', max: 40000},
                    {text: 'Devek', max: 50000},
